...
public class RoomService {
    ...
    public RoomService() {
        ...
        this.rooms.get(1).addSensor(new Sensor(1,"Sensor1","test test testtest test testtest test testtest test testtest test testtest test testtest test testtest test test", true, true,true));
